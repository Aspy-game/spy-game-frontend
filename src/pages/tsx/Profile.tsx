...
import avt1 from '../../../img/Gemini_Generated_Image_4oqsgs4oqsgs4oqs.png';
...
import avt4 from '../../../img/Gemini_Generated_Image_fkpdh6fkpdh6fkpd.png';
...
import avt8 from '../../../img/Gemini_Generated_Image_v515kev515kev515.png';
...
const Profile: React.FC<ProfileProps> = ({ onClose }) => {
  ...
  // Dữ liệu mẫu (thay thế bằng dữ liệu từ user object sau)
  const stats = {
    playedCount: 12,
          ...
          <div className="profile-content">
            <div className="profile-details">
              <div className="profile-field">
                ...
                <span className="field-value">{stats.id}</span>
              </div>
              <div className="profile-field">
              ...
              <div className="profile-field">
                ...
                <span className="field-value">{stats.playedCount}</span>
              </div>
            </div>
